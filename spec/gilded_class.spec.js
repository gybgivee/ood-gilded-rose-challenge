const NewShop = require('../src/multipleClass/shopRestyle');
const Inventory = require('../src/multipleClass/inventory');
const Backstage = require('../src/multipleClass/BackStage');
const Brie = require('../src/multipleClass/Brie');
const Conjured = require('../src/multipleClass/Conjured');
const Normal = require('../src/multipleClass/Normal');
const Legendary = require('../src/multipleClass/legend');
